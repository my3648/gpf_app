...
;(function(l) {
  ...
  ;(function(g) {
    ...
    g.post = function(b, a, d) {
      var c = t(
        'form',
        p({ method: 'post', action: b, enctype: 'multipart/form-data' }, d),
        { display: 'none' },
        z.body
      )
      E(a, function(a, b) {
    ...
    x(l.prototype, {
      ...
      getSVG: function(b) {
        ...
        this.series.forEach(function(a) {
          ...
          w.isInternal || h.series.push(w)
        })
        this.axes.forEach(function(a) {
          a.userOptions.internalKey ||
            (a.userOptions.internalKey = g.uniqueKey())
        })
      ...
      getSVGForExport: function(b, a) {
        ...
        return this.getSVG(
          p({ chart: { borderRadius: 0 } }, d.chartOptions, a, {
            exporting: {
      ...
      print: function() {
        ...
        if (!a.isPrinting) {
          ...
          if ((e = m && a.chartWidth > m))
            (h = [a.options.chart.width, void 0, !1]), a.setSize(m, void 0, !1)
      ...
      contextMenu: function(b, a, d, c, w, m, h) {
        ...
        f ||
          ...
          (p = t('div', { className: 'highcharts-menu' }, null, f)),
          e.styledMode ||
            r(
              p,
              x(
          ...
          e.exportDivElements.push(p, f),
          (e.exportMenuWidth = f.offsetWidth),
          (e.exportMenuHeight = f.offsetHeight))
        a = { display: 'block' }
        d + e.exportMenuWidth > k
          ? (a.right = k - d - w - B + 'px')
          : (a.left = d - B + 'px')
        c + m + e.exportMenuHeight > v && 'top' !== h.alignOptions.verticalAlign
          ? (a.bottom = v - c - B + 'px')
          : (a.top = c + m - B + 'px')
        r(f, a)
        e.openMenu = !0
      ...
      addButton: function(b) {
        ...
        if (!1 !== c.enabled) {
          var k = c.theme,
            ...
            f
          a.styledMode ||
            ((k.fill = u(k.fill, '#ffffff')), (k.stroke = u(k.stroke, 'none')))
          delete k.states
          g
            ? (f = function(b) {
                b && b.stopPropagation()
          ...
          c.text && c.symbol
            ? (k.paddingLeft = u(k.paddingLeft, 25))
            : c.text || x(k, { width: c.width, height: c.height, padding: 0 })
          a.styledMode ||
            ((k['stroke-linecap'] = 'round'),
            (k.fill = u(k.fill, '#ffffff')),
            (k.stroke = u(k.stroke, 'none')))
          e = d
            .button(c.text, 0, 0, f, k, l, v)
          ...
          e.add(a.exportingGroup).align(
            x(c, { width: e.width, x: u(c.x, a.buttonOffset) }),
            !0,
            'spacingBox'
          )
          a.buttonOffset +=
    ...
    l.prototype.inlineStyles = function() {
      ...
      function a(d) {
        function m(a, f) {
          ...
          for (r = g.length; r-- && !q; )
            q = g[r].test(f) || 'function' === typeof a
          q ||
            (v[f] === a && 'svg' !== d.nodeName) ||
            e[d.nodeName][f] === a ||
            (-1 !== c.indexOf(f)
              ? d.setAttribute(b(f), a)
              : (u += b(f) + ':' + a + ';'))
        }
        var f,
          v,
        ...
        if (1 === d.nodeType && -1 === h.indexOf(d.nodeName)) {
          ...
          e[d.nodeName] ||
            ((n = k.getElementsByTagName('svg')[0]),
            (w = k.createElementNS(d.namespaceURI, d.nodeName)),
            n.appendChild(w),
            (e[d.nodeName] = p(A.getComputedStyle(w, null))),
            'text' === d.nodeName && delete e.text.fill,
            n.removeChild(w))
          if (L || K) for (var x in f) m(f[x], x)
          else E(f, m)
          u &&
            ((f = d.getAttribute('style')),
            d.setAttribute('style', (f ? f + ';' : '') + u))
